...
var init = function(config) {
  ...
  Object.defineProperties(this, {
    ...
    _configFilePath: {
      ...
      configurable: false,
      value: function() {
        return '/etc/systemd/system/' + this.label + '.service';
      }
    },
    ...
    createProcess: {
      ...
      value: function(callback) {
        ...
        var filepath = p.join(this._configFilePath()),
          me = this;
    ...
    disable: {
      ...
      value: function(callback) {
        ...
        var me = this;
        var cmd = 'systemctl disable ' + this.label;
        console.log('Running %s...', cmd);
        exec(cmd, function(err) {
          if (!err) {
            /**
             * @event disable
             * Fired when the #disable method completes.
             */
            me.emit('disable');
            callback && callback();
          } else {
